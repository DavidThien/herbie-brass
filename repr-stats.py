...
for t in double_run:
    ...
    if best_copy[0] == best_copy[1]:
        ...
        if t[0] == best:
            double_start_best = double_start_best + 1
        if t[1] == best:
...
for t in single_run:
    ...
    if best_copy[0] == best_copy[1]:
        ...
        if t[0] == best:
            single_start_best = single_start_best + 1
        if t[1] == best:
...
for t in posits_run:
    ...
    if best_copy[0] == best_copy[1]:
        ...
        if t[0] == best:
            posits_start_best = posits_start_best + 1
        if t[1] == best:
...
print('Double start program is best: ' + str(double_start_best))
...
print('Single start program is best: ' + str(single_start_best))
...
print('Posits start program is best: ' + str(posits_start_best))
